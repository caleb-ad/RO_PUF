...
set_property BEL DFF [get_cells {my_ro_puf/genblk2[${i}].RO/OUT1_reg[1]}]
set_property BEL A6LUT [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A3}]
...
set_property BEL C6LUT [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A0}]
set_property BEL A6LUT [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A1}]
set_property BEL BFF [get_cells {my_ro_puf/genblk2[${i}].RO/OUT0_reg[1]}]
set_property BEL BFF [get_cells {my_ro_puf/genblk2[${i}].RO/OUT2_reg[1]}]
set_property BEL C6LUT [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A2}]
set_property BEL DFF [get_cells {my_ro_puf/genblk2[${i}].RO/OUT3_reg[1]}]
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/MUXF70}]
set_property LOC SLICE_X${baseX}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/MUXF71}]
set_property LOC SLICE_X${baseX}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/OUT1_reg[1]}]
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A3}]
set_property LOC SLICE_X${baseX}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/MUXF72}]
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/MUXF73}]
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A0}]
...
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/OUT2_reg[1]}]
set_property LOC SLICE_X${baseX}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/LUT6A2}]
set_property LOC SLICE_X${baseX + 1}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/OUT3_reg[1]}]
set_property LOC SLICE_X${baseX + 2}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/LUT60}]
set_property LOC SLICE_X${baseX + 2}Y${yPos} [get_cells {my_ro_puf/genblk2[${i}].RO/LUT61}]
